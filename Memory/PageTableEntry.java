...
public class PageTableEntry extends IflPageTableEntry
{
    ...
    {
        System.out.println("PageTableEntry][do_lock] iorb " + iorb.toString() + " this " + this.toString());
        // check page in main memory is valid
        if(!this.isValid())
        {
            System.out.println("PageTableEntry][do_lock] Invalid page. ");
            ...
            {
                System.out.println("PageTableEntry][do_lock] validating_thread is null, handlePageFault");
            ...
            {
                System.out.println("[PageTableEntry][do_lock] Suspend request thread");
            ...
            // request pagefault by same task, increase lock count
                ...
                System.out.println("PageTableEntry][do_lock] Request pagefault by same task, increase lock count");

        }
        
        FrameTableEntry frame_table_entry = this.getFrame();
        System.out.println("[PageTableEntry][do_lock] Get frame " + frame_table_entry.toString());
        System.out.println("[PageTableEntry][do_lock] Valid = " + this.isValid());
        ...
        {
            System.out.println("[PageTableEntry][do_lock] lockcount = " + lock_count);    
            return SUCCESS;
        }
        else
            return FAILURE;
